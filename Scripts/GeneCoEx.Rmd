...
ggsave("../Results/R_output/Module_line.svg", height = 4.5, width = 7, bg = "white")
ggsave("../Results/R_output/Module_line.png", height = 4.5, width = 7, bg = "white")
```
...
DotPlot(CRO_multiome, features = MYB_TFs$gene_ID.y, 
...
## Homeo 
```{r}
DotPlot(CRO_multiome, features = Homeo_TF$gene_ID.y, 
        group.by = "cell_type")$data %>% 
  mutate(id2 = case_when(
    str_detect(id, "Meso") ~ "M",
    str_detect(id, "Epi") ~ "E",
...
## WRKY
```{r}
DotPlot(CRO_multiome, features = WRKY_TF$gene_ID.y, 
        group.by = "cell_type")$data %>% 
  mutate(id2 = case_when(
    str_detect(id, "Meso") ~ "M",
    str_detect(id, "Epi") ~ "E",
